...
export default function MoUSigningSection({ onSelectMou }) {
  ...
  return (
    <section id="mou" className="py-20 bg-white border-b border-slate-100 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          ref={scrollRef}
          className="flex items-stretch gap-6 overflow-x-auto scrollbar-none pb-4 pt-2 w-full scroll-smooth"
        ...
        >
          {mouHighlights.map((mou) => (
            <div 
              ...
              className="flex-shrink-0 w-[290px] sm:w-[330px] bg-slate-50 hover:bg-white rounded-2xl p-4 border border-slate-200/80 hover:border-blue-400 hover:shadow-xl transition-all duration-300 flex flex-col justify-between group cursor-pointer"
            >
              {/* Top Badge: Year */}
              ...
              {/* Photo */}
              <div className="relative h-44 rounded-xl overflow-hidden bg-slate-900 mb-4">
                <img 
                  src={mou.image} 
                  alt={mou.collegeName}
                ...
                <div className="absolute bottom-2 left-2 right-2 text-[11px] text-white/90 bg-black/40 backdrop-blur-sm px-2 py-1 rounded-md truncate">
                  {mou.location}
                </div>
              </div>
              ...
              <div className="space-y-2 flex-1">
                <h3 className="font-bold text-base text-slate-900 font-['Outfit'] group-hover:text-blue-600 transition-colors">
                  {mou.collegeName}
                </h3>
                ...
                <div className="text-xs font-semibold text-blue-700 bg-blue-50/80 p-2 rounded-lg border border-blue-100/60">
                  {mou.mouSigned}
                </div>
